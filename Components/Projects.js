                        ...
                        <div className='md:flex'>
                            ...
                            <div>
                                <ul className='list-disc list-inside'>
                                    ...
                                    <li>You can see also user profile pic and repositories </li>
                                    <li>It made by using <a href="https://docs.github.com/en/rest" target="_blank" rel="noreferrer" className="text-emerald-300 font-medium">Github API</a> and<a href="https://reactjs.org/" target="_blank" rel="noreferrer" className="text-emerald-300 font-medium"> ReactJS </a> </li>
                                    <li>
                                        <a href="https://docs.github.com/en/rest" target="_blank" rel="noreferrer"> <span className='text-emerald-300 font-medium'>Github API</span> </a> is a simple, easy-to-use REST API that returns JSON search results for current and historic news articles published by over 80,000 worldwide sources.
                                    </li>
                                </ul>
                            </div>
                            <div className="">
