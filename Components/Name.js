...
const Name = ()=> {
  return (
    <>
      <div className="bg-slate-800 p-5 lg:px-48 lg:pt-48">
          ...
          <p className="text-gray-500 font-medium  mt-2 md:m-6">I’m a computer science and engineering student specializing in building (and occasionally
              designing) exceptional digital experiences. Currently, I’m focused on my B.tech at Nit patna and looking for opportunities for SDE role.
          </p>
